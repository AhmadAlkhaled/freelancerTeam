...
const AppForm = () => {
  ...
  const SendProjectInfo = (e) => {
    ...
    if (
      ...
      axios.post("/app-form", ProjectInfo).then((res) => {
        console.log(res);
        ...
        <form action="">
          {sent ? (
            <div className="sent-message">
              ...
              <div className="sent-message-img">
            ...
            <>
              ...
              <select
                name=""
                required
                onChange={(e) => setProjectArt(e.target.value)}
              >
                <option value="" disabled selected hidden>
                  Choose Your Project Art
                </option>
              ...
              <br />
              <label>
                How do you prefer to be contacted <span>*</span>{" "}
              </label>
              <br />
              <select
                required
              ...
              {messageError ? (
                <p style={{ color: "red" }}>
                  Message Must be Over 50 Character
                </p>
              ) : null}
