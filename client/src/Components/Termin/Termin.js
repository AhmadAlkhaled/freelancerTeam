        ...
        sentDate ?
          <div className="doneTermin">
            <div className="done-card">
              ...
              <h2><i class="fas fa-calendar-alt"></i>  {Time} - {date.getDate()} {months[date.getMonth()]} {date.getFullYear()}  <i class="fas fa-check-circle"></i> </h2>

            </div>
            <p>Thank you for your appointment. <br /> We will get in touch soon.</p>
