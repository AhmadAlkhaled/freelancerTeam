...
const DB =
  "mongodb+srv://team:team@cluster0.chvcs59.mongodb.net/?retryWrites=true&w=majority";
...
app.get("/logo", (req, res) => {
  res
    .status(200)
    .sendFile(path.join(__dirname, "../client/src/imgs/email-logo.png"));
});
    ...
    let mailOptions1 = {
      ...
      html: `
          <div 
            ...
            color:white;
            background-color:black" >
            <h1 style="color:grey">Welcome ${req.body.firstName.charAt(0).toUpperCase() + ' ' + req.body.firstName.substring(1, 100)
...
app.get("/db.data", async (req, res) => {
  ...
  res
    .status(200)
    .json({ AllDate: { Appointment, contactMassages, projectInformation } });
});
